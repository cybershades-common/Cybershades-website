...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const setupEliteServiceInteractions = () => {
    serviceCards.forEach(card => {
      const ctaBtn = card.querySelector('.service-cta');
      ...
      card.addEventListener('mouseenter', function() {
        ...
        this.style.transform = 'translateY(-12px) rotateX(2deg)';
      ...
      if (ctaBtn) {
        ctaBtn.addEventListener('click', function(e) {
          ...
          openEnhancedQuoteModal(serviceTitle, servicePrice);
